...
public class ProfileFragment extends Fragment implements ProfileInfo.OnFragmentInteractionListener, ProfileEdit.OnFragmentInteractionListener {

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {

        View view = inflater.inflate(R.layout.p_fragment_profile, container, false);
        return view;
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        final ProfilePagerAdapter adapter = new ProfilePagerAdapter(getChildFragmentManager(), tabLayout.getTabCount());
